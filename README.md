...
| `EmptySearchResultsWidgetBuilder? emptySearchResultsWidgetBuilder` | `(int count) => Align(alignment: Alignment.topCenter, child: Text('No options found from $count total'))` | A function that returns the widget to display when search returns no results. By default a widget is created using `emptySearchResultsTextBuilder`.                                                                                      |
| `EmptySearchResultsTextBuilder? emptySearchResultsTextBuilder`     | `(int count) => 'No options found from $count total'`                                                     | A function that returns the text to display when search returns no results.                                                                                                                                                              |
...
| `EmptySearchResultsWidgetBuilder` | `Widget Function(int count)`.                                               | A function type definition for building a widget to display when search returns no results. |
| `EmptySearchResultsTextBuilder`   | `String Function(int count)`.                                               | A function type definition for building the text to display when search returns no results. |
