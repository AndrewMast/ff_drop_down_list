...
| `Widget? listSeparator`               | `Divider(color: Colors.transparent, height: 0)`                  | The widget used as a separator between items in the dropdown list.                                                                                 |
| `Color? listSeparatorColor`           | `Colors.transparent`                                             | Defines the color of the default list separator `Divider`.                                                                                         |
